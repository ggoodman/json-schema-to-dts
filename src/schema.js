  ...
  switch (lType) {
    ...
    case "object":
      ...
      for (const key in l) {
        ...
        if (!isDeepEqual(l[key], r[key])) return false;
      }
      return true;
    default:
      return l === r;
...
exports.CoreSchemaMetaSchemaCodec = new Codec(
  new AllOfValidator([
    new ObjectTypeValidator({
      properties: {
        ...
        maxLength: new DeferredReferenceValidator(
          () => exports.NonNegativeIntegerCodec.validator
        ),
        minLength: new DeferredReferenceValidator(
          () => exports.NonNegativeIntegerDefault0Codec.validator
        ),
        pattern: new StringTypeValidator({}),
        additionalItems: new DeferredReferenceValidator(
          () => exports.CoreSchemaMetaSchemaCodec.validator
        ),
        items: new ConstantValidator(true),
        ...
        required: new DeferredReferenceValidator(
          () => exports.StringArrayCodec.validator
        ),
        ...
        allOf: new DeferredReferenceValidator(
          () => exports.SchemaArrayCodec.validator
        ),
        anyOf: new DeferredReferenceValidator(
          () => exports.SchemaArrayCodec.validator
        ),
        oneOf: new DeferredReferenceValidator(
          () => exports.SchemaArrayCodec.validator
        ),
...
exports.NonNegativeIntegerCodec = new Codec(
  new NumberTypeValidator({ type: "integer", minimum: 0 })
);
exports.NonNegativeIntegerDefault0Codec = new Codec(
  new AllOfValidator([
    new DeferredReferenceValidator(
      () => exports.NonNegativeIntegerCodec.validator
    ),
    new ConstantValidator(true),
  ])
);
exports.SchemaArrayCodec = new Codec(
...
exports.StringArrayCodec = new Codec(
  new ArrayTypeValidator({
    uniqueItems: true,
